...
int BUDUJ_TABLICE(char *pattern, int *tab){
...
int main(int argc, char *argv[]){
    if(argc != 3){
        printf("Wywolanie: ./wzorce wzorzec.txt tekst.txt \n Aby usunac spacje/entery uzyj: bash skrypcik.sh nazwapliku \n");
        exit(1);
    }
    int patternF = 0;
