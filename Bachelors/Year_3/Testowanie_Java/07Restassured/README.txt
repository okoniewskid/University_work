...
http://localhost:8080/restservicedemo/api/monitor/test
...
http://localhost:8080/restservicedemo/api/monitor/{ID}
powinniśmy otrzymać Monitor w formacie JSON, taką jak dodaliśmy do bazy
