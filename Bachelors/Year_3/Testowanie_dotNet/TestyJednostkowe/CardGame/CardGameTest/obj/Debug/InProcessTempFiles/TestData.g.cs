...
namespace CardGameTest {
    ...
    public partial class TestData : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(TestData).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(TestData));
        ...
        private string FindResource() {
            string[] resources = typeof(TestData).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".TestData.g.xaml") || resource.Equals("TestData.g.xaml"))) {
                    return resource;
                }
            }
